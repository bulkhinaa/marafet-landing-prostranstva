      ...
      <Container size="xl" className="relative z-10">
        <div className="grid gap-10 lg:grid-cols-[1.3fr_1fr] lg:gap-16 lg:items-center">
          ...
          <div className="flex flex-col gap-7 md:gap-9">
            ...
            <TextReveal
              as="h1"
              text="Станьте Марафет Пространством — с потоком клиентов и мастеров"
              delay={0.25}
              stagger={0.05}
              ...
              renderWord={(word) => {
                if (word === "Марафет" || word === "Пространством") {
                  return (
            ...
            <p className="max-w-xl text-pretty text-lg leading-relaxed text-ink-70 md:text-xl opacity-0 animate-[wordIn_0.7s_cubic-bezier(0.16,1,0.3,1)_0.95s_both]">
              Подключите коворкинг или салон к экосистеме Марафет. Поток
              мастеров и клиентов, бренд, IT и стандарты —{" "}
              ...
              для партнёра. Платформа зарабатывает только % с записей через приложение.
            </p>
