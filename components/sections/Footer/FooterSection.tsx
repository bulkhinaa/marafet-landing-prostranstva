...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    links: [
      ...
      // «Финмодель» (#financial) и «Оставить заявку» (#contact) скрыты вместе
      // со своими секциями — вернуть при включении секций
  ...
  },
  {
    ...
    links: [
      ...
      // «Комьюнити» (#community) скрыто вместе с секцией
    ],
  },
];
    ...
    <footer className="bg-ink-100 text-white">
      <Container size="xl">
        ...
        <div className="flex flex-col gap-4 border-t border-white/10 py-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          {/* Юр-ссылки скрыты: страниц /privacy, /terms, /offer ещё нет (вели на 404).
              Вернуть, когда документы из docs/legal/ будут опубликованы как страницы. */}
          {false && (
