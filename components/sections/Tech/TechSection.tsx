...
function Story({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-[28px] p-6 sm:rounded-[40px] sm:p-8 md:p-12 ${
        isDark
    ...
    >
      ...
      >
        {/* Phones — на мобильном горизонтальный скролл, чтобы скриншоты не обрезались */}
        <div
          className={`-mx-2 flex items-center justify-start gap-4 overflow-x-auto px-2 pb-3 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:gap-5 lg:mx-0 lg:justify-center lg:overflow-visible lg:px-0 lg:pb-0 ${reverse ? "lg:order-2" : ""}`}
        >
          {phones.map((p, i) => (
            <PhoneFrame
              key={i}
      ...
      <Container size="xl">
        ...
        <div className="mt-14">
          <Story
            ...
            phones={[
              {
                src: assetPath("/screens/screen-home.webp"),
                alt: "Главная — поиск мастеров рядом",
                priority: true,
              },
              {
                src: assetPath("/screens/screen-master-card.webp"),
                alt: "Карточка мастера с услугами и портфолио",
              },
              {
                src: assetPath("/screens/screen-booking.webp"),
        ...
        <div className="mt-8">
          <Story
            ...
            phones={[
              {
                src: assetPath("/screens/screen-master-home.webp"),
                alt: "Главная мастера — расписание и статистика дня",
              },
              {
                src: assetPath("/screens/screen-wallet.webp"),
